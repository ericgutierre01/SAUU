...
namespace SAUU.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(SAUUContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idUsuario,nombreUsuario,passUsuario,idPersona,idRol")] Usuario usuario)
        {
